...
export default function TracksTab({ challenges }) {
	...
	return (
		<>
								...
								<div key={idx} className="border-white/5">
									...
									<AnimatePresence initial={false} mode="wait">
										{isOpen && (
											...
											>
												<div className="space-y-4 bg-selected p-4 md:p-6">
			...
			{/* Desktop Split View */}
			<div className="hidden md:flex flex-col overflow-hidden  bg-zinc-950/50 h-[700px]">
				{/* Header */}
				<div className="border-b border-white/10 p-6 text-center backdrop-blur-sm">
								...
								return (
									<button
										...
										className={`group relative flex w-full items-center gap-4 px-6 py-5 text-left transition-all duration-300 ${
											isSelected
												? "z-10 -mr-px border-y border-l border-white/10 border-r-transparent bg-selected shadow-[-10px_0_20px_rgba(0,0,0,0.2)]"
				...
				<div className="relative flex w-full flex-col border-l border-white/10 bg-selected md:w-8/12 lg:w-2/3">
					<AnimatePresence mode="wait">
						{selectedTrack && (
							...
							>
								<div className="border-b border-white/5 bg-selected px-8 py-6 backdrop-blur-sm">
