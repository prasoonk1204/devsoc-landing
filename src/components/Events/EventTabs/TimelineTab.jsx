					...
					{timeline.map((item, index) => (
						...
						>
							...
							<div className="min-w-0 flex-1 pt-1">
								<span className="text-accent mb-1 block font-mono text-sm font-bold tracking-wider">
									{item.time}
								</span>
								<h4 className="font-iceland mb-2 text-lg font-bold tracking-wide text-white uppercase transition-colors duration-200 group-hover:text-white/90">
									{item.title}
								</h4>
